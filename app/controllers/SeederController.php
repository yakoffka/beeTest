...
class SeederController
{
    public static function seeding(): void
    {
        ...
        Task::create(['user_name' => 'Якав', 'email' => 'user@example.test', 'name' => 'чистка данных', 'description' => 'проверить полученные от пользователя данные']);
        ...
        Task::create(['user_name' => 'Яков', 'email' => 'vvd@example.test', 'name' => 'проверка XSS', 'description' => 'проверить приложение на отсутствие XSS уязвимости']);
    }
